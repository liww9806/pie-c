...
#ifndef BACKENDS_PIE_COMMON_OPTIONS_H_
#define BACKENDS_PIE_COMMON_OPTIONS_H_
...
class PIEOptions : public CompilerOptions {
 public:
    /// Generate externs.
...
using PIEContext = P4CContextWithOptions<PIEOptions>;

}  // end of namespace pie

#endif  // endof BACKENDS_PIE_OPTIONS_H_
